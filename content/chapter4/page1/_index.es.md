---
title:  'Instalar zkifc'
date: 2024-10-25T12:41:35-04:00
weight: 1
reading_time: 5 minutes
---

Ahora que nuestro Pi está en funcionamiento y el Zymkey está instalado, es momento de instalar el software Zymbit que necesitaremos para comunicarnos con el dispositivo.

### Instalación de `zkifc`
...
> [!CAUTION]
> La instalación de este software provocará un reinicio automático del Pi, por lo que no debe realizar ninguna otra acción con él mientras se instala el software.
...
En este punto, tu Pi ya está en funcionamiento y tu Zymkey debería funcionar correctamente. ¡Felicitaciones! Ya casi estamos listos.
